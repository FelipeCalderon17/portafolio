...
export default function Projects() {
  ...
  return (
    <>
      <ul className="max-w-[1500px] w-auto flex flex-col flex-nowrap items-start justify-center gap-10 md:flex-row md:flex-wrap md:gap-11">
        {projectList.map((project, id) => (
          <li
            key={id}
            className=" flex flex-col flex-nowrap items-center justify-center gap-7 glassy-screen !w-[380px] !min-h-[300px] !p-5 sm:!w-[3500px] sm:!min-h-[200px] sm:!p-4 md:!w-[350px] md:!min-h-[200px] md:!p-5 lg:!w-[550px] lg:!min-h-[200px] lg:!p-7"
          >
            <label className=" w-[100%] text-justify ">
              <p className="mb-[10px] mt-[20px]">Nombre:</p>
              <p> {project.nombre}</p>
            </label>
            <label className=" w-[100%] text-justify ">
              <p className="mb-[10px] mt-[20px]">Detalle:</p>
              <p>{project.detalle}</p>
            </label>

            <label className=" w-[100%] text-ellipsis overflow-hidden ">
              <p className="mb-[10px] mt-[20px]">Link:</p>
              <a href={project.link} className="max-w-[30em] w-[100%] ">
                {project.link}
              </a>
            </label>
            ...
            >
              ...
              <label className=" w-[100%]">
                ...
                <input
                  ...
                  id="linkEdit"
                  name="linkEdit"
                  className="mt-3 px-5 py-4 bg-transparent border-2 border-solid border-neutGray-500 rounded-[5px]  w-[100%] backdrop-blur-[5px]"
                  placeholder=""
                  required
